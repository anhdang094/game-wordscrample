...
insert into account (id,username,password,company,age,address) values (1,'nam','$2a$10$w7FBxSMvYyMdI4f5DEG1H./NatxztYmY2EULC83n6HGwzLUQ1VcTG','abc',18,'TPHCM');

insert into word (id, name) values (1,'the');
insert into word (id, name) values (2,'he');
